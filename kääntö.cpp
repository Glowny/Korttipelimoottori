...
int main(){
	...
	sf::RectangleShape cardSize(sf::Vector2f(170,340));
	float cardSizey = cardSize.getSize().y;
	float cardSizex = cardSize.getSize().x;
	sf::Vector2f distanceFromOrigin;
	int cardAmount = 52;
	
	int xnumber = 2048/cardSize.getSize().x;
	int ynumber = 2048/cardSize.getSize().y;
	int selectedCard = -1;
	int hoveredCard = -1;
	bool brake = false;
